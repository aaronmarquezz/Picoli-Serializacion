...
public abstract class Sector<T extends Ser> implements Serializable {
...
//		miembros = new ArrayList<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(miembros, necesidadVital, pago, reduccionMaxima);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(miembros, other.miembros)
				&& Double.doubleToLongBits(necesidadVital) == Double.doubleToLongBits(other.necesidadVital)
				&& Double.doubleToLongBits(pago) == Double.doubleToLongBits(other.pago)
				&& Double.doubleToLongBits(reduccionMaxima) == Double.doubleToLongBits(other.reduccionMaxima);
	}
