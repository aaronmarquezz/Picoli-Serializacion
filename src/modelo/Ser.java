...
public class Ser implements Serializable{
	...
	@Override
	public int hashCode() {
		return Objects.hash(edadActual, esperanzaVida, necesidadVital);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Ser other = (Ser) obj;
		return edadActual == other.edadActual
				&& Double.doubleToLongBits(esperanzaVida) == Double.doubleToLongBits(other.esperanzaVida)
